...
case INDEX_op_lduw_raw: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_lduw_raw+0), 3);
    gen_code_ptr += 3;
}
break;
...
case INDEX_op_ldsw_raw: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_ldsw_raw+0), 3);
    gen_code_ptr += 3;
}
break;
...
case INDEX_op_ldl_raw: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_ldl_raw+0), 2);
    gen_code_ptr += 2;
}
break;
...
case INDEX_op_stw_raw: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_stw_raw+0), 3);
    gen_code_ptr += 3;
}
break;
...
case INDEX_op_stl_raw: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_stl_raw+0), 2);
    gen_code_ptr += 2;
}
break;
...
extern char cpu_lock;
extern char cpu_unlock;
    memcpy(gen_code_ptr, (void *)((char *)&op_swpl_raw+0), 16);
    *(uint32_t *)(gen_code_ptr + 1) = (long)(&cpu_lock) - (long)(gen_code_ptr + 1) + -4;
    *(uint32_t *)(gen_code_ptr + 12) = (long)(&cpu_unlock) - (long)(gen_code_ptr + 12) + -4;
    gen_code_ptr += 16;
}
break;
...
case INDEX_op_vfp_lds_raw: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_vfp_lds_raw+0), 8);
    gen_code_ptr += 8;
}
break;
...
case INDEX_op_vfp_sts_raw: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_vfp_sts_raw+0), 8);
    gen_code_ptr += 8;
}
break;
...
case INDEX_op_vfp_ldd_raw: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_vfp_ldd_raw+0), 17);
    gen_code_ptr += 17;
}
break;
...
case INDEX_op_vfp_std_raw: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_vfp_std_raw+0), 17);
    gen_code_ptr += 17;
}
break;
...
case INDEX_op_iwmmxt_ldw_raw: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_iwmmxt_ldw_raw+0), 16);
    gen_code_ptr += 16;
}
break;
...
case INDEX_op_iwmmxt_stw_raw: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_iwmmxt_stw_raw+0), 9);
    gen_code_ptr += 9;
}
break;
...
case INDEX_op_iwmmxt_ldl_raw: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_iwmmxt_ldl_raw+0), 15);
    gen_code_ptr += 15;
}
break;
...
case INDEX_op_iwmmxt_stl_raw: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_iwmmxt_stl_raw+0), 8);
    gen_code_ptr += 8;
}
break;
...
case INDEX_op_iwmmxt_ldq_raw: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_iwmmxt_ldq_raw+0), 17);
    gen_code_ptr += 17;
}
break;
...
case INDEX_op_iwmmxt_stq_raw: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_iwmmxt_stq_raw+0), 17);
    gen_code_ptr += 17;
}
break;
...
case INDEX_op_shll_T1_T0_cc: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_shll_T1_T0_cc+0), 98);
    gen_code_ptr += 98;
}
break;

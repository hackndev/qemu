...
extern char cc_table;
extern char raise_interrupt;
    memcpy(gen_code_ptr, (void *)((char *)&op_into+0), 69);
    param1 = *opparam_ptr++;
...
extern char raise_exception;
    memcpy(gen_code_ptr, (void *)((char *)&op_boundw+0), 45);
...
extern char raise_exception;
    memcpy(gen_code_ptr, (void *)((char *)&op_boundl+0), 47);
...
extern char cc_table;
    memcpy(gen_code_ptr, (void *)((char *)&op_rolb_T0_T1_cc+0), 106);
...
case INDEX_op_loopnzw: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_loopnzw+0), 20);
    param1 = *opparam_ptr++;
...
case INDEX_op_bsfw_T0_cc: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_bsfw_T0_cc+0), 44);
    gen_code_ptr += 44;
}
break;
...
case INDEX_op_bsfl_T0_cc: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_bsfl_T0_cc+0), 45);
    gen_code_ptr += 45;
}
break;
...
extern char fpu_raise_exception;
    memcpy(gen_code_ptr, (void *)((char *)&op_fwait+0), 17);
...
case INDEX_op_maskmov_mmx: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_maskmov_mmx+0), 70);
    param1 = *opparam_ptr++;
    param2 = *opparam_ptr++;
    *(uint32_t *)(gen_code_ptr + 5) = param1 + 0;
    *(uint32_t *)(gen_code_ptr + 11) = param2 + 0;
...
case INDEX_op_packsswb_mmx: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_packsswb_mmx+0), 448);
    param1 = *opparam_ptr++;
    param2 = *opparam_ptr++;
    *(uint32_t *)(gen_code_ptr + 7) = param1 + 0;
...
case INDEX_op_maskmov_xmm: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_maskmov_xmm+0), 62);
    param1 = *opparam_ptr++;
    param2 = *opparam_ptr++;
    *(uint32_t *)(gen_code_ptr + 5) = param1 + 0;
    *(uint32_t *)(gen_code_ptr + 11) = param2 + 0;
...
case INDEX_op_packsswb_xmm: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_packsswb_xmm+0), 679);
    param1 = *opparam_ptr++;
    param2 = *opparam_ptr++;
    *(uint32_t *)(gen_code_ptr + 5) = param2 + 0;
    *(uint32_t *)(gen_code_ptr + 11) = param1 + 0;

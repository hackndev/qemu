...
case INDEX_op_lh_raw: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_lh_raw+0), 3);
    gen_code_ptr += 3;
}
break;
...
case INDEX_op_lhu_raw: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_lhu_raw+0), 3);
    gen_code_ptr += 3;
}
break;
...
case INDEX_op_sh_raw: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_sh_raw+0), 3);
    gen_code_ptr += 3;
}
break;
...
case INDEX_op_lw_raw: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_lw_raw+0), 2);
    gen_code_ptr += 2;
}
break;
...
case INDEX_op_lwu_raw: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_lwu_raw+0), 2);
    gen_code_ptr += 2;
}
break;
...
case INDEX_op_sw_raw: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_sw_raw+0), 2);
    gen_code_ptr += 2;
}
break;
...
extern char do_lwl_raw;
    memcpy(gen_code_ptr, (void *)((char *)&op_lwl_raw+0), 19);
    *(uint32_t *)(gen_code_ptr + 14) = (long)(&do_lwl_raw) - (long)(gen_code_ptr + 14) + -4;
    gen_code_ptr += 19;
}
break;
...
extern char do_lwr_raw;
    memcpy(gen_code_ptr, (void *)((char *)&op_lwr_raw+0), 19);
    *(uint32_t *)(gen_code_ptr + 14) = (long)(&do_lwr_raw) - (long)(gen_code_ptr + 14) + -4;
    gen_code_ptr += 19;
}
break;
...
extern char do_swl_raw;
    memcpy(gen_code_ptr, (void *)((char *)&op_swl_raw+0), 26);
    *(uint32_t *)(gen_code_ptr + 14) = (long)(&do_swl_raw) - (long)(gen_code_ptr + 14) + -4;
    gen_code_ptr += 26;
}
break;
...
extern char do_swr_raw;
    memcpy(gen_code_ptr, (void *)((char *)&op_swr_raw+0), 26);
    *(uint32_t *)(gen_code_ptr + 14) = (long)(&do_swr_raw) - (long)(gen_code_ptr + 14) + -4;
    gen_code_ptr += 26;
}
break;
...
case INDEX_op_ll_raw: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_ll_raw+0), 10);
    gen_code_ptr += 10;
}
break;
...
extern char do_raise_exception;
    memcpy(gen_code_ptr, (void *)((char *)&op_sc_raw+0), 56);
...
case INDEX_op_lwc1_raw: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_lwc1_raw+0), 8);
    gen_code_ptr += 8;
}
break;
...
case INDEX_op_swc1_raw: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_swc1_raw+0), 8);
    gen_code_ptr += 8;
}
break;
...
case INDEX_op_ldc1_raw: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_ldc1_raw+0), 17);
    gen_code_ptr += 17;
}
break;
...
case INDEX_op_sdc1_raw: {
    ...
    memcpy(gen_code_ptr, (void *)((char *)&op_sdc1_raw+0), 17);
    gen_code_ptr += 17;
}
break;
...
case INDEX_op_addo: {
    extern void op_addo();
extern char do_raise_exception;
    memcpy(gen_code_ptr, (void *)((char *)&op_addo+0), 35);
    *(uint32_t *)(gen_code_ptr + 27) = (long)(&do_raise_exception) - (long)(gen_code_ptr + 27) + -4;
    gen_code_ptr += 35;
}
break;
